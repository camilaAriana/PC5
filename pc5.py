...
# Gráfico interactivo de progreso
st.subheader("🚀 Mi progreso de aprendizaje durante el ciclo 2024-2")
progress = [20, 40, 60, 80, 100]  # Simula progreso en diferentes etapas
labels = ["PC1", "PC2", "PC3", "PC4", "PC5"]

fig, ax = plt.subplots()
ax.plot(labels, progress, marker='o', color='blue', label="Progreso")
ax.set_xlabel("Aprendizaje para las prácticas")
ax.set_ylabel("Porcentaje de dominio")
ax.set_title("Evolución de mis habilidades")
st.pyplot(fig)
